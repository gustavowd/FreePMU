...
#ifndef _ApplicationModIconButton_H
#define _ApplicationModIconButton_H
...
/* Forward declaration of the class Application::ModIconButton */
#ifndef _ApplicationModIconButton_
  EW_DECLARE_CLASS( ApplicationModIconButton )
#define _ApplicationModIconButton_
#endif
...
EW_DEFINE_FIELDS( ApplicationModIconButton, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationModIconButton )

/* Virtual Method Table (VMT) for the class : 'Application::ModIconButton' */
EW_DEFINE_METHODS( ApplicationModIconButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ApplicationModIconButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ApplicationModIconButton _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
  EW_METHOD( Restack,           void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationModIconButton )
...
#endif /* _ApplicationModIconButton_H */
