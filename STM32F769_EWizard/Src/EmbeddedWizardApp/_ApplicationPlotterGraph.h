...
/* Variant Dispatch Method Table for the class : 'Application::PlotterGraph' */
EW_DEFINE_DISPATCHER( ApplicationPlotterGraph, CoreGroup )
...
EW_END_OF_DISPATCHER( ApplicationPlotterGraph )
