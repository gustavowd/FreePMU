...
static const XRect _Const0007 = {{ 0, 0 }, { 480, 242 }};
static const XRect _Const0008 = {{ 480, 0 }, { 960, 242 }};
...
void ApplicationAplic__Init( ApplicationAplic _this, XObject aLink, XHandle aArg )
{
  ...
  CoreRectView__OnSetBounds( &_this->Janela, _Const0007 );
  CoreRectView__OnSetBounds( &_this->TFasores, _Const0007 );
  CoreGroup_OnSetEmbedded((CoreGroup)&_this->TFasores, 1 );
  CoreRectView__OnSetBounds( &_this->TFreq, _Const0008 );
  CoreGroup_OnSetEmbedded((CoreGroup)&_this->TFreq, 1 );
  CoreRectView__OnSetBounds( &_this->TMag, _Const0009 );
  ...
  ViewsText_OnSetFont( &_this->Title, EwLoadResource( &ApplicationNumbers22, ResourcesFont 
  ));
...
EW_DEFINE_FONT_RES( ApplicationNumbers18, 14, 4, 0, 16, 0x0016, 0x00BE )
  ...
  EW_FONT_PIXEL( ApplicationNumbers18, 0x0000CCC3 )             /* ratio 67.97 % */
    ...
    0x00000000
EW_END_OF_FONT_RES( ApplicationNumbers18 )

/* Table with links to derived variants of the font resource : 'Application::Numbers18' */
EW_RES_WITHOUT_VARIANTS( ApplicationNumbers18 )

/* Font resource : 'Application::Numbers16' */
EW_DEFINE_FONT_RES( ApplicationNumbers16, 13, 3, 0, 16, 0x0016, 0x00BE )
  ...
  EW_FONT_PIXEL( ApplicationNumbers16, 0x0000B3E1 )             /* ratio 76.21 % */
...
EW_END_OF_FONT_RES( ApplicationNumbers16 )

/* Table with links to derived variants of the font resource : 'Application::Numbers16' */
EW_RES_WITHOUT_VARIANTS( ApplicationNumbers16 )

/* Font resource : 'Application::Numbers22' */
EW_DEFINE_FONT_RES( ApplicationNumbers22, 18, 4, 0, 16, 0x0016, 0x00BE )
  ...
  EW_FONT_PIXEL( ApplicationNumbers22, 0x00010A1F )             /* ratio 63.29 % */
    ...
    0x00F4A807
EW_END_OF_FONT_RES( ApplicationNumbers22 )
...
void ApplicationMag__Init( ApplicationMag _this, XObject aLink, XHandle aArg )
{
  ...
  ResourcesFont ));
  ViewsText_OnSetFont( &_this->val_m_meio, EwLoadResource( &ApplicationNumbers16, 
  ResourcesFont ));
  ViewsText_OnSetFont( &_this->val_m_sup, EwLoadResource( &ApplicationNumbers16, 
  ResourcesFont ));
